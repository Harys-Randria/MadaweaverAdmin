...
export interface ApiTripTrip extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    excludes: Schema.Attribute.Enumeration<
      ['Ex:', 'morning', 'noon', 'night']
    > &
      Schema.Attribute.Required;
    ...
    images: Schema.Attribute.Media<
      ...
      true
    >;
    includes: Schema.Attribute.Enumeration<
      ['Ex:', 'morning', 'noon', 'night']
    > &
      Schema.Attribute.Required;
    itinerary: Schema.Attribute.Component<'text.itinerary', true>;
    link: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'/destinations/:id'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::trip.trip'> &
      Schema.Attribute.Private;
    location: Schema.Attribute.Component<'text.location', true> &
      Schema.Attribute.Required;
